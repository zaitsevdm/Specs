Pod::Spec.new do |spec|
  spec.name         = "ExolveSDK"
  spec.version      = "0.0.33-RNDSOFPRO-6740-1"
  spec.source       = { :http => "https://github.com/zaitsevdm/exolve-voice-sdk/releases/download/0.0.33-RNDSOFPRO-6740-1/ExolveSDK.framework.zip" }
