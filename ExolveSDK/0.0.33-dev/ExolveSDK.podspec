Pod::Spec.new do |spec|
  spec.name         = "ExolveSDK"
  spec.version      = "0.0.33-dev"
  spec.source       = { :http => "https://github.com/zaitsevdm/sdkmobile/releases/download/0.0.33-dev/ExolveSDK.framework.zip" }
