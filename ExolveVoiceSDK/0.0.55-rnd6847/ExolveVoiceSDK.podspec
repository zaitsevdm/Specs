Pod::Spec.new do |spec|
  ...
  spec.version      = "0.0.55-rnd6847"
  spec.source       = { :http => "https://github.com/zaitsevdm/exolve-voice-sdk/releases/download/0.0.55-rnd6847/ExolveVoiceSDK.xcframework.zip" }
