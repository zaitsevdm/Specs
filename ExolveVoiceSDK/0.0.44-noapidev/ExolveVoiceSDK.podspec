Pod::Spec.new do |spec|
  ...
  spec.version      = "0.0.44-noapidev"
  spec.source       = { :http => "https://github.com/zaitsevdm/exolve-voice-sdk/releases/download/0.0.44-noapidev/ExolveVoiceSDK.xcframework.zip" }
