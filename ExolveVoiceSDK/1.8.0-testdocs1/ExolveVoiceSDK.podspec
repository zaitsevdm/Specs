Pod::Spec.new do |spec|
  ...
  spec.version      = "1.8.0-testdocs1"
  spec.source       = { :http => "https://github.com/zaitsevdm/exolve-voice-sdk/releases/download/1.8.0-testdocs1/ExolveVoiceSDK.xcframework.zip" }
